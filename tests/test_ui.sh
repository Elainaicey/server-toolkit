...
runtime_locale
runtime_colors
output="$(ui_banner; ui_page "测试中心"; ui_item 1 "测试操作" "测试说明"; ui_state_item 2 "Nginx" "active" "good" "nginx.service"; ui_panel_begin "信息"; ui_panel_kv "版本" "0.3.0"; ui_panel_end; ui_action 3 "更新" "warning"; ui_action_pair 4 "启动" "success" 5 "停止" "danger"; ui_hint "格式示例"; ui_note "测试提示")"
